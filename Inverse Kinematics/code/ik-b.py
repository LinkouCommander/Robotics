...
def constraint2(x):
    ...
    """
    # FILL in your code here
    p1 = fk(x[0:1], link_lengths[0:1])
    p2 = fk(x[0:2], link_lengths[0:2])
    return line_sphere_intersection(p1, p2, obstacle_center, obstacle_radius)
...
def constraint3(x):
    ...
    """
    # FILL in your code here
    p1 = fk(x[0:2], link_lengths[0:2])
    p2 = fk(x[0:3], link_lengths[0:3])
    return line_sphere_intersection(p1, p2, obstacle_center, obstacle_radius)
